...
#    header {visibility: hidden;}
    ...
    ul[role="listbox"] li > div { padding: 0px !important; margin: 0px !important; line-height: 1 !important; height: 100% !important; display: flex !important; align-items: center !important; }

    /* 3. TRADUÇÃO E ESTILO DO UPLOADER (GESTÃO DE ARQUIVO) */
    
    /* 3.1 Criar a moldura tracejada na área de upload */
    ...
    /* 3.2 Esconder os textos nativos "Drag and drop" e "Limit 200MB" */
    [data-testid="stFileUploaderDropzoneInstructions"] div span, 
    [data-testid="stFileUploaderDropzoneInstructions"] div small { 
        display: none !important; 
    }

    /* 3.3 Customizar o botão "Browse files" */
